...
import functionly.semantic.SemanticError;
import functionly.semantic.SemanticVisitor;

public class BadSemanticTest {
    ...
    public void test1() throws IOException {
        Assert.assertNotNull(analyze("bad1.fly"));
    }

    @Test( expected = SemanticError.class )
    public void test2() throws IOException {
        Assert.assertNotNull(analyze("bad2.fly"));
    }

    @Test( expected = SemanticError.class )
    public void test3() throws IOException {
        Assert.assertNotNull(analyze("bad3.fly"));
    }

    @Test( expected = SemanticError.class )
    public void test4() throws IOException {
        Assert.assertNotNull(analyze("bad4.fly"));
    }

    private static Program analyze(String source) throws IOException {
        final ParsingTreeNode parsingTree = parse(
                Util.getSourceFromFile("bad/semantic/" + source));
